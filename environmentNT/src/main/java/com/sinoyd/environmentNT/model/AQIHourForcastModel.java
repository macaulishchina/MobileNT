 ...
 * @功能摘要：
 */
public class AQIHourForcastModel extends JSONModel {
	...
	public AQIHourForcastModel(JSONObject jsonObject) {
		super();
		try {
			parse(jsonObject);
		}
	...
	protected void parse(JSONObject jb) throws Exception {
		this.DateTime = jb.optString("DateTime").substring(11, jb.optString("DateTime").length());
