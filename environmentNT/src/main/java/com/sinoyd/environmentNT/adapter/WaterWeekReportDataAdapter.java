 ...
 * @功能摘要：
 */
public class WaterWeekReportDataAdapter extends BaseAdapter {
	/** 监测数据列表 **/
	...
	public WaterWeekReportDataAdapter(Context context, List<FactorProperty> list, RelativeLayout head) {
		mContext = context;
		mHead = head;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			if (convertView == null) { // 初始化view
				view = mLayoutInflater.inflate(R.layout.weekreport_data_item, null);
