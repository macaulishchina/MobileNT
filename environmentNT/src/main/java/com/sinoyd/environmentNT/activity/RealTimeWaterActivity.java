 ...
 * @功能摘要：
 */
public class RealTimeWaterActivity extends RefreshBaseActivity implements OnPageChangeListener, PortItemSelectListener, FactorItemSelectListener {
	/******************** 实时水质分析图表 ************************************/
	/** 图表layout **/
	...
	/** 接口方法地址 **/
	private String requestAction = RequestWaterActionName.GetLatestHourWQ;
	/** 实时水质的最新因子浓度等级值 **/
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_realtimewater);
	}
...
//		requestServer();
	...
	/**
	 * 因子选择触发事件 Copyright (c) 2015 江苏远大信息股份有限公司
	 * 
	 * @类型名称：SpinnerSelectedListener
	...
	protected void requestServer() {
		...
		requestAction = RequestWaterActionName.GetLatestHourWQ;
	...
	public void request24HourData() {
		requestAction = RequestWaterActionName.Get24HoursFactorDataWater;
		if (requestParams == null) {
			requestParams = new HashMap<String, String>();
		}
		requestParams.put("portId", portId + "");
	...
	public void requestSuccess(HttpResponse resData) {
		...
		if (RequestWaterActionName.GetLatestHourWQ.equals(resData.getUri())) {
		...
		else if (RequestWaterActionName.Get24HoursFactorDataWater.equals(resData.getUri())) {
			if (wqList == null)
