...
public class AirAlarmInfo extends RefreshBaseActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_airalarminfo);
	}
		...
		try {
			...
			if (isSuccess.equals("true")) {
				...
				if (mAlarm.values.size() == 0) {
					...
					adapter = new AlarmInfoAdapter(getActivity(), mAlarm.values, mHead);
					mDensityValueList.setAdapter(adapter);
