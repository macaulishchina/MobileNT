 ...
 */
class CommonSelectorString(val activity: Activity, val v: View, val list: ArrayList<String>, val callback: OnSelectClickListener) {
    init {
        /**显示的布局**/
        //设置父布局
...
//        listview!!.setBackgroundColor(Color.RED)
        listview!!.backgroundDrawable = activity.resources.getDrawable(R.drawable.boderwhite)
...
//        textv!!.setBackgroundColor(Color.RED)
        textv!!.backgroundDrawable = activity.resources.getDrawable(R.drawable.boderwhite)
